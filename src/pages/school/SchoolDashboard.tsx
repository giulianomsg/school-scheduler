...
export default function SchoolDashboard() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        <h1 className="text-2xl font-bold text-foreground">Welcome, {profile?.name || "Director"}</h1>
        <p className="text-muted-foreground">{profile?.school_unit || "School Dashboard"}</p>
      </div>
